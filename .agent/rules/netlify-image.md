...
---
description: Guidelines and best practices for building Netlify compute objects including serverless functions, edge functions, functions, storage, and real-world examples
